    ...
    return (
        <div className="w-full h-full relative">
            ...
            animate={{
                ...
                className="w-[300px] h-[300px] xl:w-[506px] xl:h-[506px] mix-blend-lighten 
                absolute flex items-center justify-center">
                    <div className="w-[298px] h-[298px] xl:w-[486px] xl:h-[486px] rounded-full overflow-hidden relative">
                        <Image 
